      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.15] mb-6">
            Craft Perfect
            <span className="gradient-text text-glow block mt-6">LinkedIn Messages</span>
          </h1>
          ...
          >
            Enhance your LinkedIn messaging with AI-powered composition. Save time and improve response quality while maintaining professional standards.
          </motion.p>
          ...
          >
            <Button 
              size="lg" 
              className="gradient-bg text-white hover:opacity-90 transition-all duration-300 hover-lift rounded-2xl px-8 py-6 text-lg font-medium w-full sm:w-auto"
